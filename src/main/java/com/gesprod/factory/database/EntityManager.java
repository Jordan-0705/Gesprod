...
public final class EntityManager {
    ...
    private static Map<String, String> persistenceUnitMySql(){
        ...
        config.put("url", "jdbc:mysql://localhost:3306/gesprod");
    ...
    private static Map<String, String> persistenceUnitPostgreSql() {
        ...
        // config.put("url", "jdbc:postgresql://ep-polished-mode-a4knhidj-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require");
        // config.put("user", "neondb_owner");
        // config.put("password", "npg_JPs13CwuDctF");
